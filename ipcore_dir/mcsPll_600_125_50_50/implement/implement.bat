...
xst -ifn xst.scr
move mcsPll_600_125_50_50_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\mcsPll_600_125_50_50_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc mcsPll_600_125_50_50_exdes.ucf mcsPll_600_125_50_50_exdes

echo 'Running map'
map -timing -pr b mcsPll_600_125_50_50_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm mcsPll_600_125_50_50_exdes -w routed.ncd routed.vhd
cd ..
