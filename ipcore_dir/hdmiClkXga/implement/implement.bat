...
xst -ifn xst.scr
move hdmiClkXga_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\hdmiClkXga_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc hdmiClkXga_exdes.ucf hdmiClkXga_exdes

echo 'Running map'
map -timing -pr b hdmiClkXga_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm hdmiClkXga_exdes -w routed.ncd routed.vhd
cd ..
