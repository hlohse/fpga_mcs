...
xst -ifn xst.scr
move hdmiClk720p_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\hdmiClk720p_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc hdmiClk720p_exdes.ucf hdmiClk720p_exdes

echo 'Running map'
map -timing -pr b hdmiClk720p_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm hdmiClk720p_exdes -w routed.ncd routed.vhd
cd ..
